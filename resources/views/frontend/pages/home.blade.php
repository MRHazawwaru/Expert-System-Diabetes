            ...
            <div class="container p-0 text-center">
                <div class="lh-1 fw-bolder title-home mb-5">
                    ...
                    <div class="text-white long-text">
                        <p class="fs-2 fw-bolder text-break">Web Sistem Pakar Diagnosa Penyakit Diabetes
                        </p>
                    </div>
                </div>
                <a href="{{ URL::to('/konsultasi') }}" class="btn btn-primary title-three">Mulai Konsultasi</a>
            </div>
        </div>
    </div>
@endsection
