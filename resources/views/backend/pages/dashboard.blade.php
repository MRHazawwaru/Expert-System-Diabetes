        ...
        <div class="card shadow h-100 bg-success">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <i class="fas fa-disease fa-4x text-gray" style="opacity: 0.5;"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow h-100 bg-info">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <i class="fas fa-lungs fa-4x text-gray" style="opacity: 0.5;"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow h-100 bg-warning">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <i class="fas fa-star-of-life fa-4x text-gray" style="opacity: 0.5;"></i>
                    </div>
                </div>
            </div>
        </div>
